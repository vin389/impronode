...
#            text="Inputs: cmat/dvec/rvec/tvec/imgPoints x2",
            text="(no hint)",
            font=("Arial", 7), bg="#f4efff", fg="#66508f",
        )
        ...
        status_lbl = tk.Label(
            ...
            font=("Arial", 8), bg="#f4efff", fg="#4f7f4f",
        )
        self.canvas.create_window(
    ...
    def compute(self, inputs: dict) -> dict:
        ...
        try:
            ...
            xw, _, _, reproj1, reproj2, reprojerr1, reprojerr2 = \
                triangulatePoints2(
                    cmat1, dvec1, rvec1, tvec1,
                    cmat2, dvec2, rvec2, tvec2,
                    pts1, pts2,
